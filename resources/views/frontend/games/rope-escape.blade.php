...
@section('title', 'Untangle (Rope Escape) — Villa Fabulosa')
...
@section('content')
    ...
    <div class="site_subheader">
        <div class="container">
            <div class="col-lg-12">
                <h1 class="mb-0">Untangle (Rope Escape)</h1>
            </div>
        </div>
    </div>
                    ...
                    <div class="site_video_box">
                        <div class="card">
                            <video width="100%" height="auto" controls
                                poster="{{ asset('frontend/imgs/team-bonding/villa-fabulosa-rope-escape.webp') }}">
                                <source src="{{ asset('frontend/video/1-Rope-Escape.mp4') }}" type="video/mp4">
                            </video>
                        </div>
                    </div>
                </div>
