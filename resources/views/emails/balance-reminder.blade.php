                ...
                <table role="presentation" width="640" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:24px 28px;font-size:15px;line-height:1.6;">
                            ...
                            <p style="margin:0 0 16px;">If you have any questions or need assistance, feel free to reach out—we're happy to help. Please call <strong>619-578-4013</strong>.</p>
