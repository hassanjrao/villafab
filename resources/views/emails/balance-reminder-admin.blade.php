...
<head>
    ...
    <title>Upcoming Payment Reminder (Admin)</title>
</head>
                ...
                <table role="presentation" width="700" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:20px 24px;font-size:14px;line-height:1.6;">
                            ...
                            <p style="margin:0 0 16px;">This is a reminder that the second and final payment for the following reservation will be automatically processed in <strong>{{ $reminderDays }} {{ $reminderDays === 1 ? 'day' : 'days' }}</strong>.</p>
